$(document).ready(function() {
  ...
  function createUserRow(userData) {
    ...
    newTr.append("<td><a href='/games?user_id=" + userData.id + "'>Go to GameEvents</a></td>");
    newTr.append("<td><a href='/createGames?user_id=" + userData.id + "'>Create a GameEvent</a></td>");
  ...
  function renderEmpty() {
    ...
    alertDiv.text("You must create an User before you can create a GameEvent.");
